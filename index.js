...
import { getAllMatchesExcaper } from "./services/excaper/getAllMatches.js";
import { getMatchDataExcaper } from "./services/excaper/getMatch.data.js";
...
// получение матчей
app.get("/matchesExcaperAll", async (req, res) => {
    const matches = await getAllMatchesExcaper(req.query.id);
    res.json({ matches });
});
