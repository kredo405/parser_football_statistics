...
export const getMatches = async () => {
    ...
    try {
        ...
        let arrEl = dom.window.document.querySelectorAll(".pre_match")
        arrEl.forEach(el => {
            matches.push({
                ...
                sprHome: el.querySelector('.stats_container').querySelector('.spr_row').querySelector('.home').querySelector('.position').textContent.trim(),
                sprAway: el.querySelector('.stats_container').querySelector('.spr_row').querySelector('.away').querySelector('.position').textContent.trim(),
            });
        })
